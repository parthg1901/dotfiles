...
-- Note: TypeScript/JavaScript is handled by typescript-tools.nvim (faster, more features)
local enabled_lsp_servers = {
  ...
  -- JavaScript/TypeScript: using typescript-tools.nvim instead of tsserver
  eslint = "eslint-lsp",
