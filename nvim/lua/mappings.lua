...
-- Cheatsheet: show all keybindings
keymap.set("n", "?", "<cmd>WhichKey<cr>", { desc = "Show keybinding cheatsheet" })
...
-- Switch windows (Ctrl+hjkl for better ergonomics)
