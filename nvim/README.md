...
| `<C-]>`           | Normal | Go to definition (alternative)           |
...
| `<space>gd`       | Normal | Glance definitions                       |
| `<space>gr`       | Normal | Glance references                        |
| `<space>gi`       | Normal | Glance implementations                   |

## Diagnostics

| Shortcut          | Mode   | Description                              |
|-------------------|--------|------------------------------------------|
| `<space>qw`       | Normal | Window diagnostics to quickfix           |
| `<space>qb`       | Normal | Buffer diagnostics to quickfix           |
...
| `<leader>K`       | Normal | Preview fold                             |

## Yank History (yanky.nvim)

| Shortcut          | Mode          | Description                              |
|-------------------|---------------|------------------------------------------|
| `p`               | Normal/Visual | Put after (with yank ring)               |
| `P`               | Normal/Visual | Put before (with yank ring)              |
| `[y`              | Normal        | Previous yank entry                      |
| `]y`              | Normal        | Next yank entry                          |

## Navigation

| Shortcut          | Mode                 | Description                              |
|-------------------|----------------------|------------------------------------------|
| `f`               | Normal/Visual/Opetor | Hop to character (2-char sequence)       |
| `<space>s`        | Normal               | Toggle nvim-tree                         |
| `<space>t`        | Normal               | Toggle Vista (tags)                      |
| `<space>u`        | Normal               | Toggle Mundo (undo tree)                 |
| `<space>bp`       | Normal               | Buffer pick                              |
| `n`               | Normal               | Next search result (with hlslens)        |
| `N`               | Normal               | Previous search result (with hlslens)    |
| `*`               | Normal               | Search word forward (with hlslens)       |
| `#`               | Normal               | Search word backward (with hlslens)      |

## Text Objects

| Shortcut          | Mode          | Description                              |
|-------------------|---------------|------------------------------------------|
| `iu`              | Visual/Operat | Select URL                               |
| `iB`              | Visual/Operat | Select entire buffer                     |

## Insert Mode

| Shortcut          | Mode   | Description                              |
|-------------------|--------|------------------------------------------|
| `<C-A>`           | Insert | Go to beginning of line                  |
| `<C-E>`           | Insert | Go to end of line                        |
| `<C-D>`           | Insert | Delete character to the right            |
| `<A-;>`           | Insert | Insert semicolon at end of line          |

## Miscellaneous

| Shortcut          | Mode     | Description                              |
|-------------------|----------|------------------------------------------|
| `;`               | Normal   | Use as `:` (save shift key)              |
| `H`               | Normal   | Go to line start                         |
| `L`               | Normal   | Go to line end                           |
| `J`               | Normal   | Join lines (cursor stays in place)       |
| `\D`              | Normal   | Delete all buffers except current        |
| `<leader>cb`      | Normal   | Show cursor with blink animation         |
| `<Esc>`           | Terminal | Exit terminal mode                       |
| `ga`              | Normal   | Unicode lookup                           |
| `<space>o`        | Normal   | Insert line below (no cursor move)       |
| `<space>O`        | Normal   | Insert line above (no cursor move)       |
